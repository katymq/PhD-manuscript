...
\newcommand{\PhDTitle}{Generative Markov models for sequential Bayesian classification} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Katherine Tania Morales Quinga} 															%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\NNT}{2024IPPAS019} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\ecodocacro}{Sigle}																%% Sigle de l'ED : EDIPP, EDMH / Acronym of the Doctoral School : EDIPP, EDMH
\newcommand{\ecodocnum}{000} 																%% Numéro de l'école doctorale : 626 (EDIPP), 574 (EDMH) / Doctoral School number : 626 (EDIPP), 574 (EDMH)
...
\newcommand{\defenseplace}{Télécom SudParis, campus Évry} 											%% Ville de soutenance / Place of defense
\newcommand{\defensedate}{02/10/2024} 															%% Date de soutenance / Date of defense
...
\newcommand{\jurynameB}{François Septier}
\newcommand{\juryadressB}{Professeur, Université Bretagne Sud }
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Myriam Maumy}
\newcommand{\juryadressC}{Professeure, École des Hautes Études en Santé Publique}
\newcommand{\juryroleC}{Rapporteure}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Stéphane Derrode}
\newcommand{\juryadressD}{Professeur, École Centrale de Lyon}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
% \newcommand{\jurynameE}{Emmanuel Monfrini}
% \newcommand{\juryadressE}{Professor, Télécom SudParis}
\newcommand{\jurynameE}{Yohan Petetin}
\newcommand{\juryadressE}{Maître de conférences, HDR, Télécom SudParis}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
% \newcommand{\jurynameF}{Yohan Petetin}
% \newcommand{\juryadressF}{Maître de conférences, Télécom SudParis}
% \newcommand{\juryroleF}{Co-directeur de thèse}

%%% Membre n°7 (Invité) / Member n°7 (Guest)
\newcommand{\jurynameG}{Sylvie Le Hégarat}
\newcommand{\juryadressG}{Professeure, Université Paris-Saclay}
\newcommand{\juryroleG}{Examinatrice}

%%% Membre n°8 (Invité) / Member n°8 (Guest)
\newcommand{\jurynameH}{Erwan Le-Pennec }
\newcommand{\juryadressH}{Professeur, École Polytechnique}
\newcommand{\juryroleH}{Examinateur}
...
% 	\includegraphics[scale=1]{media/etab/TSP.png} 
% \end{textblock}
...
\begin{textblock}{10}(5.7,3)
	...
	\begin{flushright}
		...
		\vfill
		École doctorale n$^{\circ}$574 ~École Doctorale de Mathématiques Hadamard
		 ~(EDMH)  \\
		
		\small{Spécialité de doctorat: Mathématiques appliquées} \\ \bigskip %% Spécialité 
		\vfill  
